...
Negotiator._setupListeners = function(connection, pc, pc_id) {
  ...
  pc.onsignalingstatechange = function(event) {
    if (pc.signalingState === "have-remote-offer") {
      pc.signalingState='stable';
      console.log("signalingState has been changed");
...
Negotiator._makeAnswer = function(connection) {
  var pc = connection.pc;
/*  console.log("Answer SignalState>>>",pc);
  pc.signalingState='stable';
*/
...
{url:'stun:stun.23.21.150.121:3478'},
{url:'stun:stun.iphone-stun.strato-iphone.de:3478'},
{url:'stun:stun.numb.viagenie.ca:3478'},
{url:'stun:stun.s1.taraba.net:3478'},
{url:'stun:stun.s2.taraba.net:3478'},
